...
from lib.math_lib.math_symbol import MathSymbol
from lib.math_lib.mathml import MathML
...
class SemanticSymbol(MathSymbol):
    ...
    def parse_from_mathml(cls, elem, parent=None, identified=None):
        ...
        #TODO: DIRTY PATCH
        # if elem.tag=="{http://www.w3.org/1998/Math/MathML}mrow":            
        #     elem.tag = MathML.list
        # if elem.tag=="qvar_$":
            
        #     elem.tag=MathML.mqvar
        ...
        # generic tag operators
            ...
            if cd == "latexml":
                ...
                if content in ["annotated", "approaches-limit", "approximately-equals-or-equals",
                               ...
                               #new added from arqmath
                               "conditional","differential-d","matrix", "qvar_$","double-factorial","implied-by","qvar_&quest","qvar_",
                               "qvar_."]:
