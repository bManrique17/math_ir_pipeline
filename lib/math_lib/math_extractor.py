...
from lib.math_lib.layout_symbol import LayoutSymbol
from lib.math_lib.semantic_symbol import SemanticSymbol
from lib.math_lib.symbol_tree import SymbolTree
from lib.math_lib.latex_mml import LatexToMathML
from lib.math_lib.exceptions import UnknownTagException
...
class MathExtractor:
    ...
    def isolate_pmml(cls, tree):
        ...
        rtype:  string
        """
        parsed_xml = BeautifulSoup(tree, features='xml')
        ...
        try:
            ...
            for idx, tree in enumerate(trees):                
                ...
                if current_tree:
                    ...
                    #Behrooz
                    result[idx] = SymbolTree(current_tree, content_id, [idx], tree)
